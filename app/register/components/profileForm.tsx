  ...
  return (
    <>
      <form onSubmit={onSubmit} className="flex flex-col gap-6 max-w-xs">
        ...
        <Input
          icon=<IdentificationIcon className="size-4 opacity-70" />
          name="employeeId"
          placeholder="123456"
          register={register}
        ...
        />
        <Input
          icon=<PhoneIcon className="size-4 opacity-70" />
          name="telephone"
...
function Input({
  ...
  return (
    <label className="input input-bordered flex items-center gap-2">
      <span className="inline-flex text-sm whitespace-nowrap after:ml-0.5 after:text-red-500 after:content-['*']">
        {icon}
        {title}
      </span>
      <input
