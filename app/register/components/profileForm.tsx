  ...
  return (
    <>
      <form onSubmit={onSubmit} className="flex flex-col gap-6 max-w-xs">
        ...
        <Input
          icon=<IdentificationIcon className="px-0 size-4 opacity-70" />
          name="employeeId"
          placeholder="123456"
          register={register}
        ...
        />
        <Input
          icon=<PhoneIcon className="px-0 grow size-4 opacity-70" />
          name="telephone"
        ...
        />
        <Input
          icon=<EnvelopeIcon className="mr-2 grow size-4 opacity-70" />
          name="email"
